    ...
    if ~isempty(Mov.seq) && ischar(Mov.seq)
        ...
        while (any(temp)) %Sequence
            ...
            if SYSPARAMS.aoms_enable(3) == 1
                Mov.aom2seq(Mov.duration) = str2num(chopped(commapos(pos)+1:commapos(pos+1)-1));
                pos = pos+1;
                Mov.aom2pow(Mov.duration) = str2double(chopped(commapos(pos)+1:commapos(pos+1)-1));
                pos = pos+1;
                Mov.aom2offx(Mov.duration) = str2num(chopped(commapos(pos)+1:commapos(pos+1)-1));
                pos = pos+1;
                Mov.aom2offy(Mov.duration) = str2num(chopped(commapos(pos)+1:commapos(pos+1)-1));
                pos = pos+1;
            end
...
if SYSPARAMS.sysmode == 3 && SYSPARAMS.realsystem == 1%Experiment
    if Mov.duration > 0
        if SYSPARAMS.aoms_enable(3) ~= 1 && SYSPARAMS.aoms_enable(4) ~= 1
            for i = 1:Mov.duration
                if i == 1
                    Mov.seq = [num2str(Mov.aom0seq(i)) ',' num2str(Mov.aom0pow(i)) ',' num2str(Mov.aom0locx(i)) ',' num2str(Mov.aom0locy(i)) ',' num2str(Mov.aom1seq(i)) ',' num2str(Mov.aom1pow(i)) ',' num2str(Mov.aom1offx(i)) ',' num2str(Mov.aom1offy(i)) ',' num2str(Mov.gainseq(i)) ','  num2str(Mov.angleseq(i)) ','  num2str(Mov.stimbeep(i)) sprintf('\t')];
                elseif i>1 && i<length(Mov.aom0seq)
                    Mov.seq = [Mov.seq num2str(Mov.aom0seq(i)) ',' num2str(Mov.aom0pow(i)) ',' num2str(Mov.aom0locx(i)) ',' num2str(Mov.aom0locy(i)) ',' num2str(Mov.aom1seq(i)) ',' num2str(Mov.aom1pow(i)) ',' num2str(Mov.aom1offx(i)) ',' num2str(Mov.aom1offy(i)) ',' num2str(Mov.gainseq(i)) ','  num2str(Mov.angleseq(i)) ','  num2str(Mov.stimbeep(i)) sprintf('\t')]; %#ok<AGROW>
                elseif i == length(Mov.aom0seq)
                    Mov.seq = [Mov.seq num2str(Mov.aom0seq(i)) ',' num2str(Mov.aom0pow(i)) ',' num2str(Mov.aom0locx(i)) ',' num2str(Mov.aom0locy(i)) ',' num2str(Mov.aom1seq(i)) ',' num2str(Mov.aom1pow(i)) ',' num2str(Mov.aom1offx(i)) ',' num2str(Mov.aom1offy(i)) ',' num2str(Mov.gainseq(i)) ','  num2str(Mov.angleseq(i)) ','  num2str(Mov.stimbeep(i))]; %#ok<AGROW>
                end
            end
        elseif SYSPARAMS.aoms_enable(3) == 1 && SYSPARAMS.aoms_enable(4) ~= 1
            for i = 1:Mov.duration
                if i == 1
...
if SYSPARAMS.sysmode == 2 || SYSPARAMS.sysmode == 3
    if SYSPARAMS.realsystem == 1
        ...
        if SYSPARAMS.board == 'm'
            ...
            aom1seq = Mov.aom1seq;
            aom1pow = Mov.aom1pow;
            aom1offx = Mov.aom1offx;
            aom1offy = Mov.aom1offy;
            aom2seq = Mov.aom2seq;
            aom2pow = Mov.aom2pow;
...
elseif SYSPARAMS.sysmode == 1 %AVI
    Mov.MovObj = mmreader(Mov.avi);
    Mov.duration = Mov.MovObj.NumberOfFrames; 
    Mov.curreplayiter = 1;
...
if Mov.frm == Mov.duration
    ...
    if SYSPARAMS.sysmode == 1
        aviframe_d = read(Mov.MovObj , Mov.frm);
    else
...
update = 0;
if SYSPARAMS.sysmode == 1
    aviframe_d = read(Mov.MovObj , Mov.duration);
else
...
if StimParams.wavfileplay == 1
    wavplay(StimParams.wavfile, 22000, 'sync');
end
