function DidItFade_Gabor_062012
...
%                 staircaseContrast = staircaseContrast;
            ...
            if staircaseviddurtotal > 6*30 %
                trialviddurtotal = 6*30;
            else 
            ...
            %update stimulus 
VideoParams.videodur = staircaseviddurtotal;
...
%             response = 2;
        ...
        if GetResponse == 0
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                ...
                psyfid = fopen(psyfname,'a+');%                 
                fprintf(psyfid,'%s\t%s\t%s\t%s\t%4.4f\t%4.4f\t%4.4f\r\n',VideoParams.vidname,num2str(horizorvert),num2str(correct),num2str(correctcounter),trialviddurtotal,staircaseviddurtotal,gain);
