function WhenDidItFade_Gabor_071212
...
staircasefactor = 1; %1.2; %1.2; %1; %1.5;
...
% locseq = 0.5.*[-80 80; 40 -40; 80 80; -40 40; -80 -80; 80 -80; -40 80; 80 -40; -80 40; -40 -80; 40 80; 40 -80; 40 40; -80 -40; 80 -40; -40 -40; -80 80; 40 -40; 80 80; -40 40; -80 -80; 80 -80; -40 80; 80 -40; -80 40; -40 -80; 40 80; 40 -80; 40 40; -80 -40; 80 -40; -40 -40;];
% locseq = 0.5.*[-80 80; 40 -40; -40 40; -80 -80; -40 80; 80 -40; -80 40; -40 -80; 40 80; 40 -80; 40 40; -80 -40; -40 -40; -80 80; 40 -40; -40 40; -80 -80; -40 80; -80 40; -40 -80; 40 80; 40 -80; 40 40; -80 -40; -40 -40;];
locseq = [-60 40; -40 -20; -20 40; -60 20; -20 -40; -40 20; -60 -40; -20 20; -60 -20; -20 20; -40 40; -40 -40; -60 40; -40 -20; -20 40; -60 20; -20 -40; -40 20; -60 -40; -20 20; -60 -20; -20 20; -40 40; -40 -40;];
...
aom0seq = ones(1,viddurtotal).*2; %framenum; 
aom0seq(end) = 0;
% aom0locx = zeros(size(aom1seq));
% aom0locy = zeros(size(aom1seq));
% aom0locx = ones(size(aom1seq)).*round(rand*(160-80));
% aom0locy = ones(size(aom1seq)).*round(rand*(160-80));
aom0locx = ones(size(aom0seq));
aom0locy = ones(size(aom0seq));
...
%                 staircaseContrast = staircaseContrast;
            ...
            if staircaseviddurtotal > 10*30 %
                trialviddurtotal = 10*30;
            else 
...
fps = 30;
presentdur = CFG.presentdur/1000;
aom0seq = ones(1,staircaseviddurtotal); 
aom0seq = ones(1,staircaseviddurtotal).*2; %framenum; 
aom0seq(end) = 0;
...
aom0locx = ones(size(aom1seq)).*locseq(trial,1); %round(rand*(160-80));
aom0locy = ones(size(aom1seq)).*locseq(trial,2); %round(rand*(160-80));
...
%                     staircaseContrast = staircaseContrast;
                ...
                trial = trial + 1;
%                 aom0locx = ones(size(aom1seq)).*round(rand*80-40);
%                 aom0locy = ones(size(aom1seq)).*round(rand*80-40);
% % %                 aom0locx = ones(size(aom1seq)).*round(rand*160-80);
% % %                 aom0locy = ones(size(aom1seq)).*round(rand*160-80);
%                 aom0locx = zeros(size(aom1seq));
%                 aom0locy = zeros(size(aom1seq));
%                 aom0locx = ones(size(aom1seq));
%                 aom0locy = ones(size(aom1seq));
%                 aom0locx = ones(size(aom1seq)).*round(rand*(120-60));
%                 aom0locy = ones(size(aom1seq)).*round(rand*(120-60));
% % %                 Mov.aom0locx = aom0locx;
% % %                 Mov.aom0locy = aom0locy;
...
imSize = 30; %40; %60; %32; %64; %32;%32; %64; %150;                           % image size: n X n
fieldsizeDeg = imSize*fieldsize/512;
cpd = 20; %15; %10; %20; %10; %12; %15;%20;                                  % target spatial frequency      
...
% for framenum = 1:2 %staircaseviddurtotal
