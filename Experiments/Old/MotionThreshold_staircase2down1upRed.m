function MotionThreshold_staircase2down1up
...
%             Mov.aom1seq = seqonoff;
            ...
            Mov.aom1seq(end) = 0;
            Mov.aom1pow(:) = SYSPARAMS.aompowerLvl(2);
            Mov.aom0locx = aom0locx;
            Mov.aom0locy = aom0locy;    
            Mov.frm = 1;
...
%             response = 2;
        ...
        if GetResponse == 0
                ...
                psyfid = fopen(psyfname,'a+');%                 
                fprintf(psyfid,'%s\t%s\t%s\t%s\t%4.4f\t%4.4f\r\n',VideoParams.vidname,num2str(clocorcountercloc),num2str(correct),num2str(correctcounter),trialRadius,staircaseRadius);
...
%                 if correct == 1
%                     correctcounter = correct + lastcorrect;
%                 elseif correct == 0;
%                     correctcounter = 0;
%                 end
%                 if (correctcounter == 2)
