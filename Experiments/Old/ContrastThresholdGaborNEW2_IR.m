...
%             Mov.aom1seq = aom1seq;
                ...
                createStimulus(viddurtotal,horizorvert,fieldsize);
                if SYSPARAMS.realsystem == 1
                    StimParams.stimpath = dirname;
                    StimParams.fprefix = fprefix;
...
%             response = 2;
        ...
        if GetResponse == 0
                ...
                psyfid = fopen(psyfname,'a+');%                 
                fprintf(psyfid,'%s\t%s\t%s\t%s\t%4.4f\t%4.4f\t%4.4f\t%2.6f\r\n',VideoParams.vidname,num2str(horizorvert),num2str(correct),num2str(correctcounter),trialRadius,staircaseRadius,gain,trialtime);
...
function createStimulus(viddurtotal,horizorvert,fieldsize)

% viddurtotal = 30*1;
minintensity = 0.6; %25;
maxintensity = 0.75;%0.5;
...
imSize = 64; %32; %64; %150;                           % image size: n X n
