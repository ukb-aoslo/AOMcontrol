...
% Last Modified by GUIDE v2.5 07-Mar-2013 12:32:23
...
CFG.kb_UpArrow = get(handles.edit_kb_repeat, 'String');
CFG.kb_DownArrow = get(handles.edit_kb_next, 'String');
CFG.kb_LeftArrow = get(handles.edit_kb_no, 'String');
CFG.kb_RightArrow = get(handles.edit_kb_yes, 'String');
...
if get(handles.yes_no_radio, 'Value') == 1;
    ...
    CFG.yes_no_radio = 1;
    CFG.two_afc_radio = 0;
%     if get(handles.catch_trials, 'Value') == 1;
%         CFG.catch_trials = 1;
%     else
%         CFG.catch_trials = 0;
%     end
...
ExpCfgParams.ir_stim_color = CFG.ir_stim_color;
% ExpCfgParams.catch_trials = CFG.catch_trials;
ExpCfgParams.offset_script = CFG.offset_script;
ExpCfgParams.ncatch = CFG.ncatch;
ExpCfgParams.nlapse = CFG.nlapse;

ExpCfgParams.multidot = CFG.multidot;
ExpCfgParams.selectionwidth = CFG.selectionwidth;
ExpCfgParams.antialiased = CFG.antialiased;

ExpCfgParams.summation = CFG.summation;
ExpCfgParams.pairs = CFG.pairs;
...
%     set(handles.catch_trials, 'Enable', 'on');
elseif get(handles.two_afc_radio,'Value')==1;
    set(handles.pCorrect, 'String', 75);
%     set(handles.catch_trials, 'Enable', 'off');
else
...
function checkbox_pairs_Callback(hObject, eventdata, handles)
