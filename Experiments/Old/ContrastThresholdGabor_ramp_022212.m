function ContrastThresholdGabor_ramp_022212
...
thresholdGuess = CFG.thresholdGuess; %max contrast level
% thresholdGuess = 40;
priorSD = CFG.priorSD;
...
experiment = ['Experiment Name: Contrast Discrimination Threshold'];
...
good_check = 1;
trialContrastminus1 = thresholdGuess;
trialContrast0 = thresholdGuess;
trialContrast1 = thresholdGuess;
trialContrast2 = thresholdGuess;
staircaseContrastminus1 = trialContrastminus1;
staircaseContrast0 = trialContrast0;
staircaseContrast1 = trialContrast1;
staircaseContrast2 = trialContrast2;
correctminus1 = 0;
correct0 = 0;
correct1 = 0;
correct2 = 0;
    ...
    elseif(resp == kb_StimConst)    % check if present stimulus button was pressed
        if PresentStimulus == 1;
                ...
                if gain == 0.5
                    ...
                    trialContrast = trialContrastminus1;
                    staircaseContrast = staircaseContrastminus1;
                ...
                elseif gain == 1.5
                    ...
                    trialContrast = trialContrast2;
                    staircaseContrast = staircaseContrast2;
                end
    
            %find out the new spot intensity for this trial (from QUEST)
            if staircaseContrast > 255 %
                trialContrast = 255;
            elseif staircaseContrast < 1 %
                trialContrast = 1;
            else 
            ...
            maxcontrast = trialContrast;
                ...
                createStimulus(viddurtotal,horizorvert,fieldsize,mincontrast,maxcontrast);
                if SYSPARAMS.realsystem == 1
...
%                 theThreshold(trial,1) = staircaseContrast; %#ok<AGROW>
                    if gain == 0.5
                        ...
                        trialContrastminus1 = staircaseContrast;
                        staircaseContrastminus1 = staircaseContrast;
                        theThresholdminus1(trial,1) = staircaseContrast; %#ok<AGROW>
                    elseif gain == 0.05
                        correct0 = correct;
                    ...
                    elseif gain == 1.5
                        ...
                        trialContrast2 = staircaseContrast;
                        staircaseContrast2 = staircaseContrast;
                        theThreshold2(trial,1) = staircaseContrast; %#ok<AGROW>
                    end
...
function createStimulus(viddurtotal,horizorvert,fieldsize,mincontrast,maxcontrast)
...
imSize = 32; %64; %150;                           % image size: n X n
fieldsizeDeg = imSize*fieldsize/512;
cpd=20;                                  % target spatial frequency      
