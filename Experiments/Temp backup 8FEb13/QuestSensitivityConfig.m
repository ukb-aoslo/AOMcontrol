...
% Last Modified by GUIDE v2.5 14-Sep-2012 15:29:22
...
elseif get(handles.mocs_radio, 'Value') == 1;
    ...
    set(handles.text16, 'Visible', 'on', 'String', 'n/Level');
...
%     ExpCfgParams.catch_trials =0;
    ExpCfgParams.offset_script = 1;
    ExpCfgParams.ncatch = 4;
    ExpCfgParams.nlapse = 4;
end
...
elseif get(handles.mocs_radio, 'Value') == 1;
    %set(handles.priorSD, 'String', 100, 'Visible', 'on');   %range aka PriorSD
    set(handles.text14, 'Visible', 'on', 'String', 'Levels');
    %set(handles.beta, 'Visible', 'on', 'String', 7);
    set(handles.text16, 'Visible', 'on', 'String', 'n/Level');
    %set(handles.delta, 'Visible', 'on', 'String', 20);
    set(handles.text19, 'Visible', 'on');
    set(handles.pCorrect, 'Visible', 'on');
    set(handles.text17, 'String', 'Range', 'Visible', 'on');
    set(handles.text13, 'Visible', 'on');
